...
import 'package:ehospital/components/src/widgets/layout_grid.dart';
...
extension LayoutGridExtensionsForBoxConstraints on BoxConstraints {
  ...
  BoxConstraints get unbound => copyWith(maxWidth: double.infinity, maxHeight: double.infinity);
