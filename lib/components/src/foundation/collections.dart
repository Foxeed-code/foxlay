extension IterableExt<E> on Iterable<E> {
  ...
  Iterable<E> removeDuplicates() => _WhereBuilderIterable(this, _removeDuplicatesPredicate);
}
...
class _WhereBuilderIterable<E> extends Iterable<E> {
  ...
  @override
  Iterator<E> get iterator => _WhereIterator(_iterable.iterator, _predicateBuilder());
}
